...
export default function Graph({
  ...
  const generateData = useCallback((stoppedAt) => {
    const newData = [];
  ...
  return (
    <div className={className}>
      <ResponsiveContainer className="relative w-full" height={410}>
        <span className="w-full  flex items-center justify-center text-center text-white text-6xl font-extrabold absolute top-[10%] z-10">
          {counter.toFixed(2)}x
        </span>
